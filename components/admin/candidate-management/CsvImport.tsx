...
export function CsvImport({ onImportComplete }: CsvImportProps) {
      ...
      for (let i = 1; i < lines.length; i++) {
        ...
        try {
          ...
          candidateService.createCandidate({
            ...
            role: (candidateData.role?.toLowerCase() === 'admin' ? 'admin' : 'candidate') as any,
            status: (candidateData.status?.toLowerCase() || 'active') as any,
            department: candidateData.department || undefined,
  ...
  const downloadTemplate = () => {
    const template = 'firstname,lastname,username,email,password,role,status,department,phone\nJohn,Doe,johndoe,john@example.com,password123,candidate,active,Engineering,+1234567890\nJane,Smith,janesmith,jane@example.com,password456,candidate,active,Marketing,+1234567891';
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 border rounded-lg">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li>• <strong>role</strong> - admin or candidate (optional, defaults to candidate)</li>
